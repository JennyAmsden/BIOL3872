...
#1: Eubalaena glacias : North Atlantic Right Whale
genus <- "Eubalaena"
species <- 'glacialis'
full_name <- "Eubalaena glacialis"
full_name2 <- paste(genus, species)
full_name2

#2: Average lifespan in years
life_span <- 70

#3: Create a logical variable
is_extinct <- FALSE
is_extant <- TRUE
...
#3 
temps[temps> 20.0]
#therefore day 2, 4, and 5 have temps above 20. 
#4
range(temps)
```
...
#1
trees <- data.frame(
  species = c("Oak", "Maple", "Pine", "Birch"),
...
#2
median(measurements$length, na.rm = TRUE)

#3
measurements_rnas <- na.omit(measurements)
measurements_rnas  
```
