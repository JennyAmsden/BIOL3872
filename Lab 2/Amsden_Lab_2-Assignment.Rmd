...
*There is a strong negative correlation between depth (m) and species count in the marine survey, such that the correlation coefficient is equal to -0.999, such that less species are found in deeper waters.*
